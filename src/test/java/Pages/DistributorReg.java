...
public class DistributorReg {
    ...
    public DistributorReg(WebDriver driver)
    {
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }
    public static String MobileNumber;
    public void distReg() throws InterruptedException, IOException {
        Thread.sleep(3000);
        linkDistReg.click();
        Thread.sleep(1000);
        Select userType=new Select(listUserType);
        userType.selectByIndex(4);
        Thread.sleep(1000);
        txtFullName.sendKeys("Test Distributor");
        Thread.sleep(1000);
        MobileNumber=Util.generateRandomMobileNumber();
        txtMobileNumber.sendKeys(MobileNumber);
        Thread.sleep(1000);
        txtProprietorName.sendKeys("Test Distributor");
        Thread.sleep(1000);
    ...
    public void distRegApprove() throws Exception {
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/div[2]/div/div[1]/div/div/ul/li[4]/a")).click();
        Thread.sleep(5000);
        String wallet=txtDistWallet.getText();
        addDescription("Distributor wallet: "+wallet);
